...
const finn ="https://vignette.wikia.nocookie.net/adventuretimewithfinnandjake/images/7/7e/Finn_with_bionic_arm-0.png/revision/latest?cb=20190807133126";

const tartToter="https://vignette.wikia.nocookie.net/adventuretimewithfinnandjake/images/7/7d/Toter.png/revision/latest?cb=20120713195935";

const lady="https://vignette.wikia.nocookie.net/adventuretimewithfinnandjake/images/a/ad/1ATLadyRainicornLook.png/revision/latest?cb=20190807133156";

const marceline="https://vignette.wikia.nocookie.net/adventuretimewithfinnandjake/images/e/e0/Marceline_Stock_Night.png/revision/latest/scale-to-width-down/95?cb=20190807133150";

const lsp="https://vignette.wikia.nocookie.net/adventuretimewithfinnandjake/images/9/9f/Lumpy_Space.png/revision/latest?cb=20110730224431";

const lemongrab="https://vignette.wikia.nocookie.net/adventuretimewithfinnandjake/images/f/f5/Earl.png/revision/latest?cb=20120723061821";

const dukeOfNuts="https://vignette.wikia.nocookie.net/adventuretimewithfinnandjake/images/5/57/Prince-of-nuts.png/revision/latest?cb=20100402183002";

const fionna="https://vignette.wikia.nocookie.net/adventuretimewithfinnandjake/images/c/c3/Fionna_new_design.png/revision/latest?cb=20140704073319";

const princessBubblegum="https://vignette.wikia.nocookie.net/adventuretimewithfinnandjake/images/0/00/Princess_Bubblegum.png/revision/latest/scale-to-width-down/100?cb=20190807133134";

let iceKing="https://vignette.wikia.nocookie.net/adventuretimewithfinnandjake/images/6/64/Original_Ice_King.png/revision/latest/scale-to-width-down/150?cb=20160405041324";

let bmo="https://vignette.wikia.nocookie.net/adventuretimewithfinnandjake/images/8/81/BMO.png/revision/latest?cb=20190807133145";

let jake="https://vignette.wikia.nocookie.net/adventuretimewithfinnandjake/images/3/3b/Jakesalad.png/revision/latest/scale-to-width-down/310?cb=20190807133015";


let fetchBtn = document.getElementById("myBtn");
let quote = document.getElementById("quote");
let imageChar = document.getElementById("imageChar");
let character = document.getElementById("nameOfChar");
...
function displayResults(str){
    ...
    quote.innerHTML=text[1];

    if (text[0] === "Finn"){ imageChar.src = finn; }
    else if(text[0] === "Tart Toter"){ imageChar.src = tartToter ; }
    else if(text[0] === "Lady"){ imageChar.src = lady ; }
    else if(text[0] === "Marceline"){ imageChar.src = marceline ; }
    else if(text[0] === "Lumpy Space Princess"){ imageChar.src = lsp ; }
    else if(text[0] === "Lemongrab"){ imageChar.src = lemongrab ; }
    else if(text[0] === "Duke of Nuts"){ imageChar.src = dukeOfNuts ; }
    else if(text[0] === "Fionna"){ imageChar.src = fionna ; }
    else if(text[0] === "Princess Bubblegum"){ imageChar.src = princessBubblegum ; }
    else if(text[0] === "BMO"){ imageChar.src = bmo ; }
    else if(text[0] === "Jake the Dog"){imageChar.src = jake ; }
    else if(text[0] === "Ice King"){ imageChar.src = iceKing; }
    else ;
